...
// Equirectangular metric distance between two lon/lat points (same approximation
// the drone-vantage airport-distance helper uses; good for parcel-scale spans).
